...
class AddProductoScreen extends StatefulWidget {
  const AddProductoScreen({Key? key}) : super(key: key);
...
class _AddProductoScreenState extends State<AddProductoScreen> {
  ...
  String _selectedCategoria = 'Alimento';
  ...
  void _save() async {
    ...
    try {
      await productsProvider.addProducto(nuevoProducto);
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('"${nuevoProducto.nombre}" agregado con éxito.'),
